...
// POST route
router.post('/push-latest-location/:serialNumber', authenticateCognitoToken, locationController.pushLatestLocation); // serial number points to iot serial number
